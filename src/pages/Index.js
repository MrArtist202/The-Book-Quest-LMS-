...
function Index() {
    ...
    const submitmsg = async (e) => {
        e.preventDefault();
        console.log("Submitting message to node server");

        try {
            const result = await fetch('http://localhost:3030/contact', {
                method: 'POST',
    ...
    return (
        <>
            <header>
                <a href="#">
                    <img id="logo" src="assets/CSS, HTML, icons/logo.png" alt="Logo" />
                </a>
                <ul id="nav">
                    <li><a className="nav-btn" href="#home">Home</a></li>
                    <li><a className="nav-btn" href="#categories">Book Shelf</a></li>
                    <li><a className="nav-btn" href="#contact">Contact Us</a></li>
                    <li><a className="nav-btn" href="assets/LoginPage/Login.html">Login/Sign Up</a></li>
                </ul>
            </header>
            <div>
            ...
            <div id="bg">
                <div id="home">
                    <h1><center>Welcome To The World Of</center></h1>
                    <h1 style={{ marginTop: "-50px" }}><center>Books</center></h1>
                    <a href="#categories" className="about-btn">Book Shelf</a>
                </div>
            </div>
            <section id="categories">
                ...
                <div className="contact-content">
                    ...
                    <div className="formBox">
                        ...
                        {showPopup && <div className="popup">Message Sent Successfully!</div>} {/* Popup message */}
                    </div>
